                ...
                switch (ruleCode) {
                    ...
                    case 3:
                        ...
                        while (value!=="___") {
                            ...
                            if (value!=="___") countryList.push(value.toUpperCase());
                        }
                    ...
                    case 4:
                        ...
                        let cutoff=parseInt(assetCommandData.getFixedPrecision().toString());
                        let voteStart=parseInt(assetCommandData.getFixedPrecision().toString())-1;
                        if ((voteLength===0)&&(cutoff!==0)) {
                            ...
                            rules.vote={
                                options: [],
                                movable,
                                cutoff: (cutoff===0)?undefined:cutoff
                            };
